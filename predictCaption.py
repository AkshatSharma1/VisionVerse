...
max_length = 150
shape = 2048
base_dir = "./Trained_models"  # provide base_dir for the model here

def load_vgg16_model(saved_model_path, flag):
...
def init_model(model_name):
    ...
    if model_name == 'bi-lstm':
        ...
        flag = False
    elif model_name == 'non-bi':
        path = os.path.join(base_dir, "non_bi_resnet.hdf5")
        flag = True
    elif model_name  == 'vgg16':
        path = os.path.join(base_dir, "vgg16_model.hdf5")
        flag = True
    else:
        path = os.path.join(base_dir, "vgg19_model.hdf5")
        flag = False
...
def get_tokenizer():
    with open("./Trained_models/vocab.pkl", 'rb') as f:
...
# load_model = init_model('bi-lstma');
# print(predict_caption(load_model, 'C:/Users/aksha/OneDrive/Desktop/test4.jpg'))
# print(predict_caption(load_model, "C:/Users/aksha/OneDrive/Desktop/test3.jpg"))
